export const PT_BR = {
   ...
   BuildingDefaultsCount: "%{count} propriedades substituidads no padrão de construção",
   BuildingDefaultsRemove: "Limpar propriedades substituidas",
   ...
   CloneFactoryDesc: "Clona qualquer recurso",
   CloneLab: "Laboratório de Clones",
   CloneLabDesc: "Converte qualquer recurso em ciência",
   CloneLabScienceMultiplierHTML: "Multiplicador de produção <b>only aplicado à construções que produzem ciência </b>(e.g. multiplicaodr de produção de Atomium)<b> não se aplicam </b> ao laboratório de clones",
   Cloth: "Tecido",
   ...
   ConfirmYes: "Sim",
   Confucius: "Confúcio",
   ConfuciusDescV2: "+%{value} Ciência de Todos os Trabalhadores, somente se mais de 50% dos trabalhadores estiverem trabalhando e menos de 50% dos trabalhadores estiverem transportando",
   ...
   CultivationLevelX: "Nível de Cultivo %{level}",
   Culture: "Cultura",
   ...
   DynamicMultiplierTooltip: "Esse multiplicador é dinâmico - não afeta trabalhadores nem armazém",
   Dynamite: "Dinamite",
   DynamiteWorkshop: "Fábrica de Dinamites",
   DysonSphere: "Dyson Sphere",
   DysonSphereDesc: "Todos as construções ganham +5 de Multiplicaodr de Produção. Essa maravilha pode ser melhorada, e cada melhoria concede +1 de Multiplicaddor de Produção a todos as construções",
   Education: "Educação",
   ...
   EmailDeveloper: "Desenvolvedor de Email",
   Embassy: "Embaixada",
   ...
   EuphratesRiverDesc:
      "A cada 10% de trabalhadores em produção (Não transporte) concede +1 de Multiplicador de Produção à todos as construções que não produzam trabalhadores (max = Número de eras desbloqueadas / 2). Quando Jardins Suspensos é construído adjascente, Jardins Suspensos ganha +1 de efeito para cada era após seu desbloqueio. Quando Descoberto, cria água em todos os blocos adjascentes que não contenham recurso",
   ...
   GreatDagonPagodaDescV2: "Todas as Pagodas são isentas de -1 dde felicidade. Gera ciência baseada na produção de fé de toiddas as Pagodas",
   ...
   GreatPeoplePickPerRoll: "Escolha de Figuras Históricas por rodada",
   ...
   HagiaSophiaDescV2: "+5 de felicidade. Contruções configuradas com 0% de Capacidade de produção são isentas de -1 de felicidade. During the game bootstrap, provide extra happiness to avoid production halt",
   ...
   InputResourceForCloning: "Insira recurso para clonagem",
   InternationalSpaceStation: "Estação Espacial Internacional",
   InternationalSpaceStationDesc: "Todas as conndtruções ganham +5 de Capacidade de Armazenamento. Essa maravilha pode ser melhorada, cada melhoria concede +1 de Capacidade de Armazenamento para todas as construções",
   Internet: "Internet",
   InternetServiceProvider: "Provedor de Internet",
   ...
   LouisSullivanDesc: "+%{value} Multiplicador de capacidade de Construtores",
   Lumber: "Lenha",
   LumberMill: "Serraria",
   LuxorTemple: "Templo de Luxor",
   LuxorTempleDescV2: "+1 de sciencia por trabalhores ocupados. Escolha uma religião ppara o empério, desbloqueie bonus extras com cada escolha",
   ...
   ManhattanProjectDesc: "Projeto Manhattan",
   Marble: "Mármore",
